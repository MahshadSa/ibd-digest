...
- [x] **Development of a Computed Tomography Enterography Based Radiomics Model to Characterize Inflammation, Fibrosis and Smooth Muscle Thickening in Stricturing Crohn's Disease.**
- [x] Read later
...
- [x] **Transmural healing is significantly associated with prevention of clinical relapse in Crohn's disease.**
- [x] Read later
...
- [x] **Roles for specialized secretory epithelial cells in inflammatory bowel disease.**
- [x] Read later
