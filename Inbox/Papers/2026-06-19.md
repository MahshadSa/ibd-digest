...
- [x] **Histologic signatures as predictors of intestinal barrier impairment in inflammatory bowel disease: integration with endoscopic and molecular markers**
- [x] Read later
