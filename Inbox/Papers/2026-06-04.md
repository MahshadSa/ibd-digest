...
- [x] **The predictive value of intestinal ultrasound for treatment response in inflammatory bowel disease: a systematic review and pooled data analysis**
- [x] Read later
...
- [x] **Early intestinal ultrasound findings predict remission and treatment response at 1 year in pediatric Crohn’s disease**
- [ ] Read later
...
- [x] **The Association of Faecal Calprotectin Measurements With Endo‐Histological Remission in Ulcerative Colitis: A Pooled Analysis**
- [x] Read later
...
- [x] **The missing evidence: Stricturing Crohn’s disease in clinical trials, a systematic review**
- [ ] Read later
...
- [x] **Intestinal ultrasound reliably predicts fecal loading in patients with ulcerative colitis**
- [x] Read later
...
- [x] **Magnetic resonance imaging-based simplified MaRIA scores are associated with future surgery in Crohn’s disease, but modest correlation with ileo-colonoscopic inflammation limits their utility in clinical trials: results from the PROFILE trial**
- [ ] Read later
...
- [x] **TL1A as a therapeutic renaissance in inflammatory bowel disease: a systematic review from molecular mechanisms to clinical translation**
- [x] Read later
...
- [x] **IOlBD evidence-based consensus on the use of artificial intelligence for assessment of endoscopic and histologic endpoints in clinical trials of inflammatory bowel disease**
- [x] Read later
...
- [x] **Transmural improvement may be an acceptable target in patients with Crohns disease**
- [x] Read later
...
- [x] **Advanced therapies for extraintestinal manifestations of IBD: a systematic review and meta-analysis**
- [ ] Read later
...
- [x] **The introduction of an intestinal ultrasound service is associated with significantly reduced endoscopy usage in an inflammatory bowel disease service—the SCOPELESS study**
- [x] Read later
...
- [x] **Disease phenotype affects treatment of late-onset inflammatory bowel disease: Analysis of a large UK cohort**
- [x] Read later
...
- [x] **Extraintestinal manifestations in Korean patients with inflammatory bowel disease: A nationwide population-based study from 2005 to 2017**
- [ ] Read later
...
- [x] **Breaking the therapeutic ceiling in inflammatory bowel disease: myth or reality?**
- [ ] Read later
...
- [x] **Transcriptomic profiling of fecal aspirates as a tool for prediction of endoscopic inflammation in small bowel Crohn’s disease**
- [ ] Read later
...
- [x] **Frailty in inflammatory bowel disease: a missing link in personalized care for the aging IBD population**
- [ ] Read later
...
- [x] **Ustekinumab resistance in individuals with ulcerative colitis is associated with an alteration of a subset of proinflammatory mucosal regulatory T cells**
- [ ] Read later
...
- [x] **Long-Term Disease Course of Crohn’s Disease in a Prospective European Population-Based Inception Cohort: An Epi-IBD Cohort Study**
- [x] Read later
...
- [x] **Efficacy and safety of subcutaneous guselkumab induction therapy in participants with moderately to severely active ulcerative colitis (ASTRO): a double-blind, treat-through, randomised, placebo-controlled, phase 3 trial**
- [ ] Read later
...
- [x] **Real-world patient characteristics, treatments, and outcomes during and after severe ulcerative colitis hospitalization**
- [ ] Read later
...
- [x] **Intestinal ultrasound to detect postoperative recurrence in patients with Crohn's disease: an international, multidisciplinary, RAND/UCLA appropriateness method study**
- [ ] Read later
...
- [x] **Translating multiomics prediction into clinical care in Crohn’s disease: Moving beyond proof of concept**
- [x] Read later
...
- [x] **IBD in transition: a decade of data from the Malaysian Kinta Valley cohort**
- [x] Read later
...
- [x] **Real-world evidence on medication patterns in inflammatory bowel disease the first decade after diagnosis**
- [x] Read later
...
- [x] **What are the top 10 global research priorities for perianal Crohn’s disease? The Global Perianal Crohn’s Disease Priority Setting Partnership**
- [ ] Read later
...
- [x] **Anatomy is not activity: rethinking MRI fistula volume in perianal Crohn’s disease**
- [ ] Read later
...
- [x] **Time to rethink washout periods in inflammatory bowel disease clinical trials: an international Delphi consensus**
- [x] Read later
...
- [x] **Rethinking the dose: A Bayesian meta-analysis of infliximab intensification in acute severe ulcerative colitis**
- [x] Read later
...
- [x] **Bayesian prior elicitation on the efficacy of medical therapies in perianal fistulizing Crohn’s disease**
- [ ] Read later
...
- [x] **Multimodal AI for early prediction of adverse clinical outcomes in acute pancreatitis**
- [x] Read later
...
- [x] **Translating Explainable Artificial Intelligence Principles Into Radiology Practice**
- [x] Read later
  Jie Feng
...
>
> - **The Use of Non‐Contrast Abbreviated MRI for the Detection of Recurrent Hepatocellular Carcinoma in Postoperativ Surveillance**
...
>
> - **Characterization of Pulmonary Functional Abnormalities in Systemic Sclerosis Using XenonMRI**
...
>
> - **A Study on Predicting Split Renal Function Using Renal Blood Flow Weighted Estimated Glomerular Filtration Rate From Arterial Spin Labeling MRI**
...
>
> - **Editorial: Do We Need to Adapt GERD Metrics Based on the Population Being Evaluated?**
...
>
> - **Optimal Selection of the Effective Echo Time ( TE eff  ) for T2 ‐Weighted Fast‐Spin‐EchoMRI of the Prostate at 3.0 T: Effect on Lesion Conspicuity**
...
>
> - **Editorial for “Relationship Between Dp140 Genotype and Cortical Similarity Network Phenotype in Duchenne Muscular Dystrophy: Preliminary T1  Weighted Study”**
>   Sam Geuens
...
>
> - **Editorial for “Hypointensity on Carotid Plaque MRI and Its Relationship to Calcification: Histopathologic Validation With Quantitative Susceptibility Mapping”**
